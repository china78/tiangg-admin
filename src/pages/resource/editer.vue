            ...
            >
              ...
              >
                ...
                <el-form-item label="内容">
                  <template v-if="categoryType=='image'">
                    ...
                    <upload
                      ...
                      :showBtn="true"
                      :auto="true"
                      @uploadSuccess="uploadContentEnd"
                    ></upload>
                  </template>
                  ...
                  <template v-if="categoryType=='combinedcomponent'">
                    <code-editer
                      ...
                      :contents='JSON.stringify(JSON.parse(form.content),null,2)'
                    ></code-editer>
                  </template>
                </el-form-item>
                ...
                <el-form-item
                  label="描述"
                  prop="desc"
                  :rules="[{ required: false,message: '输入描述', trigger: 'blur'},
