  ...
  <div class="">
    ...
    <div class="panel panel-default">
      ...
      <ul class="content-list">
        <li
          class="group_member js-toggle-container"
          :key="key"
        ...
        >
          <div class="controls">
            <template v-if="canLeave||item.userId != userInfo.userId">
              ...
              >
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item
                    :key="e.value"
                    v-for="e in Metadata.groupPower"
                    trigger="click"
                    :command="e.value + ',' + item.userId"
                  >{{e.label}}
                  </el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            ...
            <a
              v-if="(item.userId === userInfo.userId)&&canLeave"
              class="btn btn-remove"
              @click="remove(item,true)"
            >离开</a>
            <a
              v-if="item.userId != userInfo.userId&&info.role<=1"
              class="btn btn-remove"
              @click="remove(item)"
            >移除</a>
          </div>
