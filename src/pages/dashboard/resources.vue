        ...
        <section class="activities">
          ...
          <div class="searchTags">
            <el-tag
              :type="tag.type||'info'"
              class="tag"
              v-for="(tag,key) in canSelectTags"
              :key="key"
          ...
          <div class="content_list">
            ...
            >
              ...
              <div
                class="sourceImg"
                v-if="typeMap[item.categoryId+''] == 'image'"
              >
                <img
                  :src="item.content+'?x-oss-process=image/resize,h_200'"
                  alt=""
                >
              </div>
              ...
              <div
                class="sourceAudio"
                v-if="typeMap[item.categoryId+''] == 'audio'"
              >
              ...
              <div
                class="sourceVideo"
                v-if="typeMap[item.categoryId+''] == 'video'"
              >
                <video
                  controls="controls"
                  :src="item.content"
              ...
              <div
                class="sourceImg"
                v-if="typeMap[item.categoryId+''] == 'script'"
              >
                <img src="../../assets/image/javascr.jpg">
              </div>
              <div
                class="sourceImg"
                v-if="typeMap[item.categoryId+''] == 'combinedcomponent'"
              >
                <img :src="item.icon">
              </div>
