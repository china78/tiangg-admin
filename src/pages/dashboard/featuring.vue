<template>
  ...
  >
    <div class='container-fluid container-limited box'>
      ...
      <div
        class="boxSize"
        v-for="(item, k) in featuringPages"
        :key='k'
      >
        <div class="sourceImg">
          <a
          ...
          >
            <img
              :src="item.image||'https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/access/ymm1562307855048.png'"
              class="logo"
            >
          </a>
        </div>
    ...
    <div class="loadmore">
      <el-button
        ...
        type="text"
      >再来一波 <i class="el-icon-refresh"></i> </el-button>
      <el-button
        style="font-size: 20px;"
        v-else
        type="text"
